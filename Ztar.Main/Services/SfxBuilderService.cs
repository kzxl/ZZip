...
namespace Ztar.Main.Services
{
    ...
    {
        /// <summary>LogicalName of the embedded prebuilt stub executable (see Ztar.Main.csproj).</summary>
        private const string StubResourceName = "Ztar.SfxStub";
        ...
        private static byte[] LoadStubBytes()
        {
            ...
            if (s == null)
            {
                throw new InvalidOperationException(
                    "Không tìm thấy stub giải nén được nhúng. Hãy build lại dự án để MSBuild đóng gói Ztar.Stub.");
            }
