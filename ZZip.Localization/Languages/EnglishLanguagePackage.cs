...
public sealed class EnglishLanguagePackage : BaseLanguagePackage
{
    ...
    private static Dictionary<string, string> CreateDictionary() => new()
    {
        ...
        // Dialogs & Messages
        ["Dialog_AddArchive_Title"] = "Add to Archive (ZZip)",
        ["Msg_SelectSourceFirst"] = "Please select a valid source file or folder before proceeding.",
        ["Msg_ConfirmUnregisterShell"] = "ZZip is currently integrated into Windows Explorer context menu. Do you want to remove it?",
        ["Msg_ShellRemoved"] = "Successfully removed ZZip from Windows Explorer context menu.",
        ["Msg_ShellAdded"] = "Successfully registered ZZip into Windows Explorer context menu!",
        ...
        ["Msg_ArchiveInfo"] = "ZZip Archive Information",
        ["Msg_AboutTitle"] = "About ZZip Sovereign Archiver",
        ...
        ["Shell_OpenStudioCurrent"] = "Open ZZip Studio here...",
