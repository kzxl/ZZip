...
public sealed class JapaneseLanguagePackage : BaseLanguagePackage
{
    ...
    {
        // Window & Brand
        ["App_Title"] = "ZZip — 超高速圧縮スタジオ ＆ アーカイブエクスプローラー",
        ...
        // Dialogs & Messages
        ["Dialog_AddArchive_Title"] = "アーカイブへの追加 (ZZip)",
        ...
        ["Shell_OpenStudioCurrent"] = "ここで ZZip Studio を開く...",
        ["Shell_ZZipArchiveDesc"] = "ZZip アーカイブ (.zz)"
    };
}
