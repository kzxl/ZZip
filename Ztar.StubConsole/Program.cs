...
namespace Ztar.StubConsole;

/// <summary>
/// Cross-platform (Windows/Linux/macOS) headless self-extractor. Reads the Ztar footer from
/// the end of its own executable and extracts the payload. Usage:
///   Ztar.Stub [target-dir] [-p password] [-y]
...
internal static class Program
{
    private static int Main(string[] args)
    {
        ...
        if (footer == null)
        {
            Console.Error.WriteLine("Tệp này không chứa dữ liệu nén Ztar.");
            return 1;
        }
        ...
        Console.WriteLine($"Ztar - Trình giải nén [{footer.Method}]"
    ...
    {
        Console.WriteLine("""
Ztar self-extractor (đa nền tảng)
