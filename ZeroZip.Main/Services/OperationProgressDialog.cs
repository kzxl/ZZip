    ...
    public class OperationProgressDialog : BaseForm
    {
        ...
        protected override async Task RunAfterShown()
        {
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show(this, "Thao tác thất bại: " + ex.Message, "Lỗi ZeroZip", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private async Task ExecuteOperationAsync()
        {
            ...
            else if (_opType == OperationType.Extract)
            {
                ...
                await Task.Run(() =>
                {
                    ...
                    if (footer == null) throw new InvalidDataException("Tệp không phải gói ZeroZip hợp lệ.");
