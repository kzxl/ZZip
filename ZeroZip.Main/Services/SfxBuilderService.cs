...
namespace ZeroZip.Main.Services
{
    ...
    {
        /// <summary>LogicalName of the embedded prebuilt stub executable (see ZeroZip.Main.csproj).</summary>
        ...
        private static byte[] LoadStubBytes()
        {
            ...
            if (s == null)
            {
                throw new InvalidOperationException(
                    "Không tìm thấy stub giải nén được nhúng. Hãy build lại dự án để MSBuild đóng gói ZeroZip.Stub.");
            }
