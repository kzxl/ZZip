...
namespace SZip.Core
{
    ...
    /// <summary>
    /// Fixed-size trailer written at the very end of an SZip SFX executable (or a
    ...
    /// </summary>
    public sealed class SZipFooter
    {
        /// <summary>"SZIPSFX" + version byte 0x01 packed as a little-endian ulong.</summary>
        public const ulong Magic = 0x01_58_46_53_50_49_5A_53UL; // 'S','Z','I','P','S','F','X',0x01
        ...
        public SZipFlags Flags { get; set; }
        ...
        /// <summary>Number of external volumes when <see cref="SZipFlags.MultiPart"/> is set; 0 otherwise.</summary>
        public int PartCount { get; set; }

        public bool IsMultiPart => (Flags & SZipFlags.MultiPart) != 0;
        public bool IsAppended => (Flags & SZipFlags.Appended) != 0;
        public bool IsEncrypted => (Flags & SZipFlags.Encrypted) != 0;
        public bool IsPrecompressed => (Flags & SZipFlags.Precompressed) != 0;
        ...
        /// Returns null when the trailing magic is absent (i.e. not an SZip SFX file).
        /// </summary>
        public static SZipFooter? ReadFromEnd(Stream seekableStream)
        {
