...
namespace ZeroZip.Core.Streams
{
    ...
    /// underlying seekable stream. Used by the extractor to read just the appended
    /// payload bytes from inside the SFX executable without seeing the footer.
    /// </summary>
    public sealed class SubStream : Stream
    {
        ...
        public override int Read(byte[] buffer, int offset, int count)
        {
            ...
            // Guard against interleaved seeks on the shared inner stream.
