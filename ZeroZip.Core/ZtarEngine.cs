...
namespace ZeroZip.Core
{
    ...
    public sealed class CompressionOptions
    {
        ...
        /// to raise windowLogMax, which ZeroZip does automatically via the footer's WindowLog.
        /// </summary>
    ...
    /// <summary>Outcome of a <see cref="ZtarEngine.Pack"/> call.</summary>
    ...
    /// <summary>One file or directory entry inside an archive, as reported by <see cref="ZtarEngine.ListEntries"/>.</summary>
