...
namespace ZeroZip.StubConsole;

/// <summary>
/// Cross-platform (Windows/Linux/macOS) headless self-extractor. Reads the ZeroZip footer from
/// the end of its own executable and extracts the payload. Usage:
///   ZeroZip.Stub [target-dir] [-p password] [-y]
...
internal static class Program
{
    private static int Main(string[] args)
    {
        ...
        if (footer == null)
        {
            Console.Error.WriteLine("Tệp này không chứa dữ liệu nén ZeroZip.");
            return 1;
        }
        ...
        Console.WriteLine($"ZeroZip - Trình giải nén [{footer.Method}]"
    ...
    {
        Console.WriteLine("""
ZeroZip self-extractor (đa nền tảng)
